...
![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled.png)
...
![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%201.png)
...
- Tensorflow의 경우에는 코드가 크게 두가지로 나뉨
    ...
    - 모델을 학습할 때, GPU에서 계산한 값을 CPU(Numpy)로 보냈다가 다시 GPU로 보내는 과정에서 보틀넥이 발생. 이를 방지하기 위해 tf.Variable로 그냥 tensorflow의 변수로 선언
        ...
        ![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%202.png)
...
- Keras : Tensorflow를 backend로 해서 computational graph를 알아서 만들어줌
    ...
    ![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%203.png)
...
![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%204.png)
...
![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%205.png)
...
![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%206.png)
...
- PyTorch를 사용할 때, 전체 네트워크 모델이 정의되어 있는 Class를 nn module class로 작성해야 함
    ...
    ![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%207.png)
...
![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%208.png)
...
![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%209.png)
...
- 조건부 연산의 경우
    ...
    ![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%2010.png)
...
- 반복문의 경우
    ...
    ![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%2011.png)
...
- Recursive network
    ...
    ![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%2012.png)
    
    - 그래프를 구성할 때 데이터의 구조를 반영하도록 구성해 유동적인 네트워크 형성
- Modular Networks
    
    ![Untitled](Lecture%208%208e5a9dd11a25419d8ee400a66f505bae/Untitled%2013.png)
